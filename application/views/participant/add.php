    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Participant Add</h3>
            </div>
            <?php echo form_open('participant/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_event" class="form-control">
								...
								{
									$selected = ($event['id_event'] == $this->input->post('id_event')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nom_participant" value="<?php echo $this->input->post('nom_participant'); ?>" class="form-control" id="nom_participant" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="telephone_participant" value="<?php echo $this->input->post('telephone_participant'); ?>" class="form-control" id="telephone_participant" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="email_participant" value="<?php echo $this->input->post('email_participant'); ?>" class="form-control" id="email_participant" />
