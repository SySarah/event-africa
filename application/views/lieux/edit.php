    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Lieux Edit</h3>
            </div>
			<?php echo form_open('lieux/edit/'.$lieux['id_lieu']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="adresse_lieu" value="<?php echo ($this->input->post('adresse_lieu') ? $this->input->post('adresse_lieu') : $lieux['adresse_lieu']); ?>" class="form-control" id="adresse_lieu" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nbreplace_lieu" value="<?php echo ($this->input->post('nbreplace_lieu') ? $this->input->post('nbreplace_lieu') : $lieux['nbreplace_lieu']); ?>" class="form-control" id="nbreplace_lieu" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="createAt" value="<?php echo ($this->input->post('createAt') ? $this->input->post('createAt') : $lieux['createAt']); ?>" class="has-datetimepicker form-control" id="createAt" />
						</div>
					</div>
				</div>
			</div>
